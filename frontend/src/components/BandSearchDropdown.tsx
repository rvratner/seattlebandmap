...
interface BandSearchDropdownProps {
	value: string
...
const BandSearchDropdown: React.FC<BandSearchDropdownProps> = ({
	value,
	onChange,
	placeholder,
	apiUrl,
	...
	return (
		<div className="band-search-dropdown" ref={dropdownRef} style={{ position: 'relative', width: '100%' }}>
			<input
				type="text"
				value={value}
...
export default BandSearchDropdown
